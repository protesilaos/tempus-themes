...
hi Search gui=underline,bold guibg=#8e8f8d guifg=#322622 cterm=underline,bold, ctermbg=15 ctermfg=0
hi IncSearch gui=underline,bold guibg=#919078 guifg=#322622 term=none cterm=bold ctermbg=7 ctermfg=0
...
hi TabLineSel gui=none guibg=#83973f guifg=#322622 cterm=none ctermbg=2 ctermfg=0
...
hi MatchParen gui=underline guibg=#9d80d3 guifg=#322622 cterm=underline ctermbg=13 ctermfg=0
...
hi Title gui=bold guifg=#229ea0 cterm=bold ctermfg=14
...
hi Underlined gui=none,bold guifg=#8e8f8d cterm=underline,bold ctermfg=15
...
hi Pmenu guibg=#919078 guifg=#35260f ctermbg=7 ctermfg=8
hi PmenuSel guibg=#35260f guifg=#83973f ctermbg=8 ctermfg=2
hi PmenuSbar guibg=#8e8f8d ctermbg=15
hi PmenuThumb guibg=#35260f ctermbg=8
