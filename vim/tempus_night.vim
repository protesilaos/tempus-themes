...
hi TabLineSel gui=none guibg=#e0e0e0 guifg=#1a1a1a cterm=none ctermbg=15 ctermfg=0
hi TabLineFill gui=none cterm=none

hi Comment gui=italic guifg=#c4bdaf cterm=italic ctermfg=7
...
hi MatchParen gui=underline,bold guibg=#de99f0 guifg=#1a1a1a cterm=underline,bold ctermbg=13 ctermfg=0
...
hi Underlined gui=underline,bold guifg=#e0e0e0 cterm=underline,bold ctermfg=15
...
hi Pmenu gui=italic guibg=#18143d guifg=#e0e0e0 cterm=italic ctermbg=8 ctermfg=15
