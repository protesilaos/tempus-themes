...
hi Search gui=underline,bold guibg=#798ba5 guifg=#202427 cterm=underline,bold, ctermbg=15 ctermfg=0
hi IncSearch gui=underline,bold guibg=#888a8a guifg=#202427 term=none cterm=bold ctermbg=7 ctermfg=0
...
hi TabLineSel gui=none guibg=#589584 guifg=#202427 cterm=none ctermbg=2 ctermfg=0
...
hi MatchParen gui=underline guibg=#987dc2 guifg=#202427 cterm=underline ctermbg=13 ctermfg=0
...
hi Title gui=bold guifg=#1f96b0 cterm=bold ctermfg=14
...
hi Underlined gui=none,bold guifg=#798ba5 cterm=underline,bold ctermfg=15
...
hi Pmenu guibg=#888a8a guifg=#1b2431 ctermbg=7 ctermfg=8
hi PmenuSel guibg=#1b2431 guifg=#589584 ctermbg=8 ctermfg=2
hi PmenuSbar guibg=#798ba5 ctermbg=15
hi PmenuThumb guibg=#1b2431 ctermbg=8
