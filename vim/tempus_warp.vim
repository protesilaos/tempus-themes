...
hi Search gui=underline,bold guibg=#928f90 guifg=#141a19 cterm=underline,bold, ctermbg=15 ctermfg=0
hi IncSearch gui=underline,bold guibg=#927B80 guifg=#141a19 term=none cterm=bold ctermbg=7 ctermfg=0
